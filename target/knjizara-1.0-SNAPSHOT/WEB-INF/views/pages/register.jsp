                ...
                <div class="container align-self-center">
                    <div class="row justify-content-center">
                        <div class="col-12 col-md-6">
                            ...
                            <form:form method="POST" action="/knjizara/korisnik/register" modelAttribute="posetilac">
                                <div class="form-row justify-content-center pt-4 pb-4 text-center">
                                    ...
                                    <div class="col-5 mb-2">
                                        <form:input type="text" placeholder="Ime" path="ime" class="form-control" required="required" />
                                    </div>
                                    
                                    <div class="col-5 mb-2">
                                        <form:input type="text" placeholder="Prezime" path="prezime" class="form-control" required="required" />
                                    </div>
...
<!--                                    <div class="col-10">
                                    ...
                                    <div>
                                        <p class="mb-0 text-white">Već posedujete nalog?</p>
                                        <p class="text-white">Vrati se na <a href="/knjizara/login">login.</a></p>
                                    </div>
