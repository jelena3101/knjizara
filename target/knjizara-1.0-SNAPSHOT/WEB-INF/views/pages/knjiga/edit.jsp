                        ...
                        <div class="col-md-12 gradient-card bg-white px-5">
                            ...
                            <div class="row setup-content justify-content-center" id="step-1">
                                <div class="col-12">
                                    ...
                                    <form:form method="POST" action="saveEdit" modelAttribute="knjiga">
                                        <div class="row justify-content-center">
                                            <div class="col-12 col-md-6">

                                                
                                                <div class="form-row form-group justify-content-center mt-5">
                                                    <form:input type="text" placeholder="Naslov" path="naslov" value="${saveKnjiga.naslov}" class="form-control" required="required" />                                
                                                </div>
                                                ...
                                                <div class="form-row form-group justify-content-center">
                                                    <form:input type="text" placeholder="Link ka slici knjige" path="slika" value="${saveKnjiga.slika}" class="form-control" required="required" />                                
                                                </div>
                                            ...
                                            <div class="col-12 col-md-6">
                                                ...
                                                <div class="form-row">
                                                    <div class="col-12 mt-3">
                                                        ...
                                                        <c:forEach var="i" begin="${saveKnjiga.zanrovi.size()}" end="2">  
                                                            <div class="form-group d-flex genre">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <form:input type="number" placeholder="Godina" path="godina" value="${saveKnjiga.godina}" class="form-control" min="1900"/>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group d-flex align-items-center">
                                                            ...
                                                            <form:select path="jezik" class="form-control mr-3" size="size" multiple="false" >
                                                                ...
                                                                <form:option value="slovenački" label="slovenački" />
